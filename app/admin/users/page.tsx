        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-surface/30 border border-white/5 p-8 rounded-[2.5rem] backdrop-blur-sm shadow-2xl">
                <div className="space-y-2">
                    ...
                    <h1 className="text-4xl font-black tracking-tighter text-white">Profesores Registrados</h1>
                    <p className="text-gray-400 text-sm max-w-md">Supervisa las cuentas de profesores y el progreso de sus estudiantes.</p>
                </div>

                <div className="bg-white/5 px-6 py-3 rounded-2xl border border-white/5 flex items-center gap-4">
                    <div className="text-right">
                        <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Total Profesores</p>
                        <p className="text-xl font-black text-amber-500">{teachers.length}</p>
                    </div>
                    <div className="w-px h-8 bg-white/10" />
                    <div className="text-right">
                        <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Total Estudiantes</p>
            ...
            {teachers.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-20 text-center space-y-6 bg-white/[0.02] border-2 border-dashed border-white/5 rounded-[3rem]">
                    ...
                    <h3 className="text-xl font-bold text-gray-500">No hay profesores registrados aún</h3>
                </div>
            ) : (
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">
                                        Registrado: {new Date(teacher.created_at).toLocaleDateString()}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-bold text-gray-400">
                                        {teacher.students?.length || 0} {teacher.students?.length === 1 ? 'Estudiante' : 'Estudiantes'}
                                    </span>
                                </div>
