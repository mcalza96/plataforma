...
export default function CopilotSidebar({ onApplyStructure, isInline = false }: CopilotSidebarProps) {
    ...
    const content = (
        <div className={`flex-1 flex flex-col ${!isInline ? 'p-6' : ''} overflow-hidden animate-in fade-in slide-in-from-right duration-500`}>
            {!isInline && (
